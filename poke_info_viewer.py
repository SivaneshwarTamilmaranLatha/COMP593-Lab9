...
btn_get_info.grid(row=0, column=2, padx=(10,5), pady=(10,10), sticky=E)
...
lbl_height_val.grid(row=0, column=1, padx=(0,10), pady=(10,5), sticky=E)
...
lbl_weight_val.grid(row=1, column=1, padx=(0,10), pady=(10,5), sticky=E)
...
lbl_type_val.grid(row=2, column=1, padx=(0,10), pady=(10,5), sticky=E)
